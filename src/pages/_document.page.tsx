  ...
  render() {
    return (
      <Html lang="en">
        ...
        <meta
          name="description"
          content="amnesia - Where in the pampa am I?"
        />

        <meta property="og:url" content="https://www.amnesia/" />
        ...
        <meta
          property="og:image"
          content="https://amnesia/og_1200x630.png"
        />

        <meta name="twitter:card" content="summary_large_image" />
        <meta property="twitter:domain" content="amnesia" />
        <meta property="twitter:url" content="https://www.amnesia/" />
