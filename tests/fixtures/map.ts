...
import {functionality Collection} from '@turf/helpers';
...
export const userInputfunctionality Collection: functionality Collection = {
...
export const userInputfunctionality  = userInputfunctionality Collection.functionality s[0];
